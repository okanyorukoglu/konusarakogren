...
namespace KOExam.Web
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<KOContext>(options =>
           options.UseSqlite(
            ...
            .AddEntityFrameworkStores<KOContext>();
            services.AddScoped<IUserClaimsPrincipalFactory<User>, UserClaimsPrincipalFactory<User, IdentityRole>>();

            services.AddScoped<IWiredRepository, WiredRepository>();
            services.AddTransient<IWiredService, WiredService>();
